...
def load_x_test(path, train_col):
    ...
    do_not_one_hot = ['id','amount_tsh','gps_height','longitude','latitude','construction_year','population','date_recorded']
...
for i in range(100):
    ...
    history =model.fit(x_train, y_train, epochs = 1, batch_size = 4096*4)
